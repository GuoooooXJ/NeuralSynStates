function [varargout] = dnsdetectionSWT(signal, fs, node, varargin)
...
for iStep = 1:nStep
    ...
    cfsTemp = DwithoutEdge(FrequencyBand,(1:winlen)+(iStep-1)*step);
...
for iStep = 1:nStep
    ...
    cfsThrs(1:end-step) = cfsThrs(step+1:end);
    cfsThrs(end-step+1:end) = cfsTemp;
